...
function Description() {
    return(
        <div id="description" className='des-content 567:pb-[180px] pb-[64px]'> 
            <Row className='row'>
                ...
                >
                    <div className='des-content-word m-0'>
                    ...
                    <Button type="primary" className='flex btn-primary px-[34px] py-[19px] mt-5 font-bold' >
