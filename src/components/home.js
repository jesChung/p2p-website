    ...
    return(
        <div id="about us" className='content pb-12'> 
            ...
            <div className="btnHolder flex justify-center my-[100px] md:mt-[80px] md:mb-[200px]" >
                ...
                <Button type="primary" className='btn-primary btn-primary-home btnlearn '>Learn more</Button>
            </div>
        </div>
    );
}
